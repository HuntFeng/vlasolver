...
geometric_jump(-1, Direction.T, vars_m=case1_top_vars_m, vars_p=case1_top_vars_p)
...
geometric_jump(-1, Direction.L, vars_m=case1_left_vars_m, vars_p=case1_left_vars_p)
